...
const data = [...speaking, ...features].sort((itemA, itemB) => (itemA.year > itemB.year ? -1 : 1))
...
const FeatureInner: FC<{
	...
	<>
		...
		<p className="m-0 shrink-0 text-sm transition-colors group-hover:text-orange-400">{year}</p>
	</>
)
